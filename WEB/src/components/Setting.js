...
const Setting = () => {
    ...
    return(
        <div className='role-list'>
         ...
         <h1 className='font-f' style={{color:'gray'}}>Setting </h1>
        <Button variant="contained" className='role-btn'  onClick={() => { history.push("/Setting_Form") }}> Create Setting</Button>
        </div>
            ...
            <Table aria-label="collapsible table" >
              <TableHead>
                <TableRow>
                  ...
                  <TableCell align="center" style={{ fontWeight: '600', fontSize: '0.97rem' }}>Key</TableCell>
                  <TableCell align="center" style={{ fontWeight: '600', fontSize: '0.97rem' }}>Value</TableCell>
                  <TableCell align="center" style={{ fontWeight: '600', fontSize: '0.97rem' }}>Description</TableCell>
