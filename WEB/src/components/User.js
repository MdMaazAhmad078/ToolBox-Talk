...
const User = () => {
    ...
    return(
        ...
        <div className='flex justify-between'>
         <h1 className='font-f' style={{color:'gray'}}>User </h1>
        <Button variant="contained" className='role-btn'  onClick={() => { history.push("/User_Form") }}> Create User</Button>
        </div>
            ...
            <Table aria-label="collapsible table" >
              <TableHead>
                <TableRow>
                  ...
                  <TableCell align="center" style={{ fontWeight: '600', fontSize: '0.97rem' }}>Login</TableCell>
                  <TableCell align="center" style={{ fontWeight: '600', fontSize: '0.97rem' }}>Expire Date</TableCell>
                  <TableCell align="center" style={{ fontWeight: '600', fontSize: '0.97rem' }}>Category</TableCell>
                  <TableCell align="center" style={{ fontWeight: '600', fontSize: '0.97rem' }}>Level</TableCell>
                  <TableCell align="center" style={{ fontWeight: '600', fontSize: '0.97rem' }}>Status</TableCell>
