...
const Parameter = () => {
    ...
    return(
        ...
        <div className='flex justify-between'>
         <h1 className='font-f' style={{color:'gray'}}>Parameters </h1>
        <Button variant="contained" className='role-btn'  onClick={() => { history.push("/Parameter_Form") }}> Create Parameter</Button>
        </div>
             <TableContainer component={Paper} style={{ boxShadow: 'none' }}>
            <Table aria-label="collapsible table" >
              <TableHead>
                <TableRow>
                  <TableCell style={{ fontWeight: '600', fontSize: '0.97rem' }}>Id</TableCell>
